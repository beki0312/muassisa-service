...
func NewRouter(d dependencies) {
	...
	//courseRoute.HandleFunc("/get-courseNew", d.Handler.GetCourseNew()).Methods("GET", "OPTIONS")
	courseRoute.HandleFunc("get_courseNew", d.Handler.GetCourseNew()).Methods("GET", "OPTIONS")
	srv := http.Server{
