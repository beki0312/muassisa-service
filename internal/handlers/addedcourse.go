...
func (ch Handler) AddedCourse() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		filePath := fmt.Sprintf("/home/c83335/schooltaj.na4u.ru/www/assets/%s%s", uuid, ext)
		...
		err = ch.svc.RepositoryInstance().AddedCourse(name, title, description, imageName, uuid+ext, int64(summa), int64(lang))
		if err != nil {
